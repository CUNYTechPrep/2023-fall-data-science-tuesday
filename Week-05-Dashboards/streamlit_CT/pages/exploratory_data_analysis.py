...
st.image(img, width=400, caption="Image of Titanic Ship")
...
add a Machine Learning model for easy use by external customers. The Titanic unfourtantely sinked on May 31st of 1911.
"""
